...
const Profile = () => {
  ...
  const { name, age, weight, feet, inches } = useSelector(
  ...
  const getInitials = (name) =>
    name?.split(" ").map((character) => character[0]?.toUpperCase());

  return (
    //Profile card
    <div className="bg-red-50 rounded-md  text-black overflow-hidden mt-8">
      {/* header */}
