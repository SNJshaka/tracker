...
const Dashboard = () => {
  ...
  return (
    <div className="h-full w-full text-black font-poppins flex flex-col justify-center items-center">
      <div className="bg-white rounded-xl shadow-lg shadow-white/30 p-6 mb-8">
        <h2 className="font-bold">Calories Burnt Today / Target</h2>
          ...
          <div className="w-1/2 flex flex-col gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs 2xl:text-lg 3xl:text-2xl font-bold">
                  {" "}
                  {caloriesRequired}{" "}
                </p>
              </div>
