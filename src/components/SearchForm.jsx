  ...
  return (
    <form onSubmit={onSubmitHandler}>
      <motion.input
        ...
        value={enteredMeal}
        placeholder="Input food eaten"
        className="rounded-full mb-2 w-[90%] mx-auto block p-1.5 px-4 outline-none text-black placeholder:text-xs 2xl:placeholder:text-lg 3xl:placeholder:text-2xl focus:w-full mt-8"
      ></motion.input>
    </form>
  );
};
